...
public class PrintManagerOverride extends CModule {
	
	public PrintManagerOverride() {
		super("MANAGER OVERRIDE", false);
	}
	...
	public void execute(String[] args, Scanner sc) {
		...
		try {
			Main.getDB().update("INSERT INTO `paper_overrides` (`operator_id`, `override_number`, `level`, `expiration_time`) VALUES ('" + operator.getOperatorId() + "', '" + ("999002" + operator.getOperatorId() + "" + expires) + "', " + operator.getOverrideType().getPower() + ", '" + expires + "');");
